                                ...
                                <li key={item.menu_id}>
                                    <Fade up delay={600}>
                                        <div className="flex  mt-5  text-slate-200  ">
                                            <img src={BACKEND_BASE_URL +item.image} alt={item.item_name} className="w-1/3 h-1/3" />
                                            <div className='mx-3'>
                    ...
                    <Fade right delay={500}>
                        <div className="w-1/3 h-1/2  mx-1 p-5 bg-slate-800 text-slate-200" >
                            <Fade up delay={600}>
                                ...
                                <button onClick={() => onCheckoutButtonClicked()}className="bg-amber-500 float-right hover:bg-orange-700 text-white font-bold px-5 py-2 my-3 rounded-full">
                                    Checkout
                                </button>
                            </Fade>
                        </div>
